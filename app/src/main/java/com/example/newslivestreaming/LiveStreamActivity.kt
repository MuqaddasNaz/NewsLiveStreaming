...
import com.example.newslivestreaming.databinding.ActivityLiveStreamBinding
...
class LiveStreamActivity : AppCompatActivity() {
    ...
    private var context: Context = this@LiveStreamActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        expandableMenu = binding.expandableMenu

        // Enable disk reads on the main thread temporarily
        ...
        // Prepare the media source (assuming videoUrl is a valid URL)
...
//            "      نیوز7 سچ کے ساتھ | بریکنگ نیوز: سپریم کورٹ نے انتخابات کا لعدم قرار دینے کی درخواست خارج کردی۔             نیوز7 سچ کے ساتھ | بریکنگ نیوز: سپریم کورٹ نے انتخابات کا لعدم قرار دینے کی درخواست خارج کردی۔                نیوز7 سچ کے ساتھ | بریکنگ نیوز: سپریم کورٹ نے انتخابات کا لعدم قرار دینے کی درخواست خارج کردی۔"
        ...
        }, 0, MainActivity.SCROLL_INTERVAL)
    }
